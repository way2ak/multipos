<?php
/**
 * Order Stats Controller
 *
 * @package MultiPOS - Point of Sale for WCFM Marketplace
 * @version 1.0.0
 */

namespace DDWCMultiPOS\Api\Includes\Reports\Orders;

use DDWCMultiPOS\Api\DDWCPOS_Data_Store;

defined( 'ABSPATH' ) || exit();

class DDWCPOS_API_Orders_Stats_Controller extends \WC_REST_Reports_Controller {
	/**
	 * Base Name.
	 *
	...
	public function ddwcpos_get_data( $request ) {
		...
		$data_store = DDWCPOS_Data_Store::load( 'report-orders-stats' );
	...
	public function prepare_item_for_response( $report, $request ) {
		 ...
		 */
		return apply_filters( 'ddwcpos_rest_prepare_report_orders_stats', $response, $report, $request );
	}
}
